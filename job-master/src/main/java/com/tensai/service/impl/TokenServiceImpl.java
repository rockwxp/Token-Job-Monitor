...
public class TokenServiceImpl implements TokenService {
    ...
    public String getTokenTask(String taskOwner) {
        ...
        if(taskToken!=null){
            ...
            taskToken.setUpdatedTime(new Timestamp(System.currentTimeMillis()));
